        ...
        <div class="col-md-12 col-md-offset-0">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('saveEditedProfile',$user->id ) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="col-sm-5">
                            <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    <input id="age" type="text" class="form-control" name="age" value="{{ $user->age }}" autofocus>
